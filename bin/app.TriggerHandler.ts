      ...
      Thread: [
        {
          PutRequest: {
            Item: {
              ...
              LastPostedDateTime: { S: "2015-09-22T19:58:22.514Z" },
              Views: { N: "0" },
              Replies: { N: "0" },
              Answered: { N: "0" },
              Tags: {
                L: [{ S: "index" }, { S: "primarykey" }, { S: "table" }],
              },
            },
          },
        },
        {
          PutRequest: {
            Item: {
              ...
              LastPostedBy: { S: "User A" },
              LastPostedDateTime: { S: "2015-09-15T19:58:22.514Z" },
              Views: { N: "3" },
              Replies: { N: "0" },
              Answered: { N: "0" },
              Tags: {
                L: [{ S: "items" }, { S: "attributes" }, { S: "throughput" }],
              },
            },
          },
        },
        {
          PutRequest: {
            Item: {
              ...
              Message: { S: "S3 thread 1 message" },
              LastPostedBy: { S: "User A" },
              LastPostedDateTime: { S: "2015-09-29T19:58:22.514Z" },
              Views: { N: "0" },
              Replies: { N: "0" },
              Answered: { N: "0" },
              Tags: {
