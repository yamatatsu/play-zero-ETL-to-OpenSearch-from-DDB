...
export class SimpleDynamodbOsisStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: Props) {
    super(scope, id, props);
    const { table, domain, role } = props;
    ...
    new osis.CfnPipeline(this, "OSISPipeline", {
      pipelineName: "simple-dynamodb-osis",
      minUnits: 1,
      maxUnits: 4,
        ...
        dynamodb-pipeline:
              ...
              tables:
                ...
                - table_arn: ${table.tableArn}
                  ...
                  export:
                    ...
                    # s3_prefix: "simple-dynamodb-osis/"
              aws:
          ...
          sink:
            - opensearch:
                ...
                index: simple-dynamodb-osis-index
                index_type: custom
